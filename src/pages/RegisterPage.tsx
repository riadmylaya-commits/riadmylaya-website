...
export default function RegisterPage() {
  ...
  const renderInput = (field: string, labelKey: string, labelEnKey: string, type = 'text', hintKey?: string) => (
    <FormField
      label={t(labelKey)}
      labelEn={isFr ? t(labelEnKey) || undefined : undefined}
      hint={hintKey ? t(hintKey) || undefined : undefined}
      error={errors[field]}
    >
  ...
  const renderDateInput = (field: string, labelKey: string, labelEnKey: string, hintKey?: string) => (
    <FormField
      label={t(labelKey)}
      labelEn={isFr ? t(labelEnKey) || undefined : undefined}
      hint={hintKey ? t(hintKey) || undefined : undefined}
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit} noValidate>
          <div className="bg-white/60 border border-beige-200 rounded-2xl p-6 md:p-8">
            ...
            {renderInput('cinNumber', 'cinNumber', 'cinNumberEn', 'text', 'cinNumberHint')}
            {renderInput('moroccoEntryNumber', 'moroccoEntryNumber', 'moroccoEntryNumberEn', 'text', 'moroccoEntryNumberHint')}
            ...
            {renderInput('comingFrom', 'comingFrom', 'comingFromEn', 'text', 'comingFromHint')}
            {renderInput('goingTo', 'goingTo', 'goingToEn', 'text', 'goingToHint')}
            {renderInput('passportNumber', 'passportNumber', 'passportNumberEn')}
            {renderDateInput('passportIssueDate', 'passportIssueDate', 'passportIssueDateEn', 'passportIssueDateHint')}
            {renderInput('passportIssuePlace', 'passportIssuePlace', 'passportIssuePlaceEn', 'text', 'passportIssuePlaceHint')}
