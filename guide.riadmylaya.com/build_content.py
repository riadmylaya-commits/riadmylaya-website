...
SERVICES = [
    ("Hammam & Massage", "Hammam & Massage",
     "Hammam traditionnel et massage à l'huile d'argan, sur réservation.",
     "Traditional hammam and argan-oil massage, on request.",
...
FR = {
    ...
    "sections": [
            ...
            "blocks": [
                {
                    ...
                    "features": {
                        ...
                        "list": [
                            ...
                            "Terrasse panoramique sur la médina",
                            "Hammam traditionnel (sur réservation)",
                            "Chambres authentiques climatisées",
        ...
        },
        {
            ...
            "times": [
                {"label": "Horaires", "value": "8h00 – 10h30", "detail": "Servi tous les jours."},
                {"label": "Où", "value": "Patio ou terrasse", "detail": "Vous choisissez l'endroit qui vous plaît le plus."},
                {"label": "Formule", "value": "Inclus", "detail": "Crêpes marocaines, pain maison, confitures, œufs, jus frais, thé et café."},
            ],
            "items": [
                ...
                {"title": "Petit-déjeuner plus tôt ou plus tard", "text": "Excursion matinale ou grasse matinée ? Nous pouvons décaler l'heure de votre petit-déjeuner sur simple demande.",
                 "actions": [{"label": "Demander un horaire", "href": wa("Bonjour, je souhaite décaler l'heure de mon petit-déjeuner."), "external": True}]},
            ],
        },
        {
            "id": "dinner", "shortTitle": "Dîner", "type": "dinner",
            "eyebrow": "Gastronomie", "title": "Dîner marocain au riad",
            "lead": "Dînez sous les étoiles, sur la terrasse ou dans le patio. Nos plats sont préparés le jour même avec des produits frais du marché, selon les recettes traditionnelles marocaines.",
            "image": IMG + "dinner.jpg",
            "imageAlt": "Dîner traditionnel servi au Riad Mylaya",
            "menus": [
                {"icon": "🍲", "label": "Tajine traditionnel", "detail": "Poulet citron confit, agneau pruneaux ou kefta", "price": "Sur demande"},
                {"icon": "🥘", "label": "Couscous royal", "detail": "Le vendredi ou sur commande la veille", "price": "Sur demande"},
                {"icon": "🍽️", "label": "Menu complet", "detail": "Salades marocaines + plat + dessert", "price": "Sur demande"},
                {"icon": "🌿", "label": "Menu végétarien", "detail": "Légumes de saison et épices douces", "price": "Sur demande"},
            ],
            "dinnerHeader": {"title": "Réserver le dîner", "subtitle": "Prévenez-nous avant 16h le jour même"},
            "bookButton": "Réserver le dîner",
            "perPerson": "",
            "badges": [
                {"icon": "🕯️", "text": "Dîner sur la terrasse ou dans le patio"},
                {"icon": "🌿", "text": "Produits frais du marché, faits maison"},
                {"icon": "❤️", "text": "Recettes traditionnelles de la famille"},
            ],
            "form": {
                ...
                "menuOptions": [
                    {"label": "Tajine traditionnel"}, {"label": "Couscous royal"},
                    {"label": "Menu complet"}, {"label": "Menu végétarien"},
                ],
                "currency": "€", "currencyBefore": False, "perPerson": "/ personne",
                "summary": {"guestsLabel": "Nombre de personnes", "priceLabel": "Prix", "totalLabel": "Total",
                            "placeholder": "L'équipe du riad vous confirmera le tarif exact avec votre réservation."},
        ...
        },
        {
            ...
            "lead": "Apprenez à préparer un tajine ou un couscous avec notre cuisinière, puis dégustez votre plat sur la terrasse. Une expérience conviviale de 3 heures environ, du marché à l'assiette.",
            "image": IMG + "cooking.jpg",
            "imageAlt": "Cours de cuisine marocaine au Riad Mylaya",
            "menus": [
                {"icon": "🍋", "label": "Tajine", "detail": "Poulet au citron confit ou agneau", "price": "45 €"},
                {"icon": "🥣", "label": "Couscous", "detail": "Semoule roulée à la main et légumes", "price": "45 €"},
                {"icon": "🥗", "label": "Salades marocaines", "detail": "Assortiment d'entrées traditionnelles", "price": "45 €"},
                {"icon": "🍪", "label": "Pâtisseries marocaines", "detail": "Cornes de gazelle, briouates au miel", "price": "45 €"},
            ],
            "dinnerHeader": {"title": "Réserver le cours", "subtitle": "À réserver au moins 24h à l'avance"},
            "bookButton": "Réserver le cours de cuisine",
            "perPerson": "/ personne",
            "badges": [
                {"icon": "🧑‍🍳", "text": "Avec notre cuisinière, en petit groupe"},
                {"icon": "🛒", "text": "Visite du marché possible en option"},
                {"icon": "🍽️", "text": "Vous dégustez ce que vous cuisinez"},
            ],
            "form": {
                "title": "Réservation cours de cuisine",
                "fields": {"name": "Nom", "email": "E-mail", "date": "Date souhaitée", "time": "Heure souhaitée",
                           "guests": "Nombre de personnes", "menu": "Plat souhaité",
                           "message": "Message / allergies / préférences"},
                "menuOptions": [
                    {"label": "Tajine", "price": 45}, {"label": "Couscous", "price": 45},
                    {"label": "Salades marocaines", "price": 45}, {"label": "Pâtisseries marocaines", "price": 45},
                ],
                "currency": "€", "currencyBefore": False, "perPerson": "/ personne",
                "summary": {"guestsLabel": "Nombre de personnes", "priceLabel": "Prix", "totalLabel": "Total",
                            "placeholder": "Choisissez un plat pour voir le total."},
                "submit": "Envoyer la réservation",
...
EN = {
    ...
    "sections": [
            ...
            "blocks": [
                {
                    ...
                    "features": {
                        ...
                        "list": [
                            ...
                            "Panoramic terrace over the medina",
                            "Traditional hammam (on request)",
                            "Authentic air-conditioned rooms",
        ...
        },
        {
            ...
            "times": [
                {"label": "Times", "value": "8:00 – 10:30 am", "detail": "Served every day."},
                {"label": "Where", "value": "Patio or terrace", "detail": "Choose whichever spot you prefer."},
                {"label": "Included", "value": "Yes", "detail": "Moroccan pancakes, homemade bread, jams, eggs, fresh juice, tea and coffee."},
            ],
            "items": [
                ...
                {"title": "Earlier or later breakfast", "text": "Early excursion or a lie-in? We can shift your breakfast time on request.",
                 "actions": [{"label": "Request a time", "href": wa("Hello, I would like to change my breakfast time."), "external": True}]},
            ],
        },
        {
            "id": "dinner", "shortTitle": "Dinner", "type": "dinner",
            "eyebrow": "Food", "title": "Moroccan dinner at the riad",
            "lead": "Dine under the stars, on the terrace or in the patio. Our dishes are prepared the same day with fresh market produce, following traditional Moroccan recipes.",
            "image": IMG + "dinner.jpg",
            "imageAlt": "Traditional dinner served at Riad Mylaya",
            "menus": [
                {"icon": "🍲", "label": "Traditional tagine", "detail": "Chicken with preserved lemon, lamb with prunes or kefta", "price": "On request"},
                {"icon": "🥘", "label": "Royal couscous", "detail": "On Fridays or ordered the day before", "price": "On request"},
                {"icon": "🍽️", "label": "Full menu", "detail": "Moroccan salads + main course + dessert", "price": "On request"},
                {"icon": "🌿", "label": "Vegetarian menu", "detail": "Seasonal vegetables and mild spices", "price": "On request"},
            ],
            "dinnerHeader": {"title": "Book dinner", "subtitle": "Please let us know before 4pm on the day"},
            "bookButton": "Book dinner",
            "perPerson": "",
            "badges": [
                {"icon": "🕯️", "text": "Dinner on the terrace or in the patio"},
                {"icon": "🌿", "text": "Fresh market produce, homemade"},
                {"icon": "❤️", "text": "Traditional family recipes"},
            ],
            "form": {
                ...
                "menuOptions": [
                    {"label": "Traditional tagine"}, {"label": "Royal couscous"},
                    {"label": "Full menu"}, {"label": "Vegetarian menu"},
                ],
                "currency": "€", "currencyBefore": False, "perPerson": "/ person",
                "summary": {"guestsLabel": "Number of people", "priceLabel": "Price", "totalLabel": "Total",
                            "placeholder": "The riad team will confirm the exact price with your booking."},
        ...
        },
        {
            ...
            "lead": "Learn to prepare a tagine or a couscous with our cook, then enjoy your dish on the terrace. A friendly 3-hour experience, from the market to the plate.",
            "image": IMG + "cooking.jpg",
            "imageAlt": "Moroccan cooking class at Riad Mylaya",
            "menus": [
                {"icon": "🍋", "label": "Tagine", "detail": "Chicken with preserved lemon or lamb", "price": "€45"},
                {"icon": "🥣", "label": "Couscous", "detail": "Hand-rolled semolina and vegetables", "price": "€45"},
                {"icon": "🥗", "label": "Moroccan salads", "detail": "A selection of traditional starters", "price": "€45"},
                {"icon": "🍪", "label": "Moroccan pastries", "detail": "Gazelle horns, honey briouates", "price": "€45"},
            ],
            "dinnerHeader": {"title": "Book the class", "subtitle": "To be booked at least 24h in advance"},
            "bookButton": "Book the cooking class",
            "perPerson": "/ person",
            "badges": [
                {"icon": "🧑‍🍳", "text": "With our cook, in a small group"},
                {"icon": "🛒", "text": "Optional market visit"},
                {"icon": "🍽️", "text": "You eat what you cook"},
            ],
            "form": {
                "title": "Cooking class reservation",
                "fields": {"name": "Name", "email": "E-mail", "date": "Preferred date", "time": "Preferred time",
                           "guests": "Number of people", "menu": "Dish you would like to cook",
                           "message": "Message / allergies / preferences"},
                "menuOptions": [
                    {"label": "Tagine", "price": 45}, {"label": "Couscous", "price": 45},
                    {"label": "Moroccan salads", "price": 45}, {"label": "Moroccan pastries", "price": 45},
                ],
                "currency": "€", "currencyBefore": True, "perPerson": "/ person",
                "summary": {"guestsLabel": "Number of people", "priceLabel": "Price", "totalLabel": "Total",
                            "placeholder": "Choose a dish to see the total."},
                "submit": "Send the reservation",
