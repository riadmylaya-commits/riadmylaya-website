...
(function () {
  ...
  var I18N = {
    fr: {
      ...
      wa: {
        dinner: "Bonjour, je souhaite réserver le dîner marocain {at}.",
        cooking: "Bonjour, je souhaite réserver le cours de cuisine {of}.",
        excursions: "Bonjour, je souhaite réserver une excursion privée {with}.",
    ...
    en: {
      ...
      wa: {
        dinner: "Hello, I would like to book the Moroccan dinner {at}.",
        cooking: "Hello, I would like to book the {of} cooking class.",
        excursions: "Hello, I would like to book a private excursion {with}.",
    ...
    es: {
      ...
      wa: {
        dinner: "Hola, quiero reservar la cena marroquí {at}.",
        cooking: "Hola, quiero reservar la clase de cocina {of}.",
        excursions: "Hola, quiero reservar una excursión privada {with}.",
