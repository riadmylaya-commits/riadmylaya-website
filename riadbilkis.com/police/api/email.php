...
function sendRegistrationEmail(array $reg): bool {
    ...
    try {
        ...
        $mail->setFrom(GMAIL_EMAIL, 'Riad Bilkis');
...
<h2 style="color:#5a2d1e;text-align:center;">Riad Bilkis &mdash; Nouvelle Fiche Client</h2><hr style="border-color:#ebe0cc;">
...
function sendPasswordResetEmail(string $email, string $username, string $resetUrl): bool {
    ...
    try {
        ...
        $mail->Subject = 'Riad Bilkis - Reinitialisation du mot de passe';
...
<h2 style="color:#5a2d1e;text-align:center;">Riad Bilkis</h2>
